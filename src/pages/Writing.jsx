      ...
      <div id="Writing" className="tabContent">
        ...
        <div id="TechWriting">
          ...
          <ul className="WritingList">
												<li>
														<a href="username.github.io/PDFs/Tear.pdf" target="_blank">Sample 1: The Science Behind Tear Gas: Conceptual/Reference/Task Document</a>
												</li>
												<li>
														<a href="username.github.io/PDFs/Smoke.pdf" target="_blank">Sample 2: MacGyver Smoke Powder lab procedure: Conceptual/Reference/Task Document</a>
												</li>
												<li>
														<a href="username.github.io/PDFs/Give.pdf" target="_blank">Sample 3: Readme.MD for a charity app: Conceptual/List/Task Document</a>
												</li>
          </ul>
        </div>
      </div>
